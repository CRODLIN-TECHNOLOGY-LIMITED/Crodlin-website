...
import { Github, Linkedin, Twitter, Mail, MapPin, Phone, ChevronRight, ExternalLink } from 'lucide-react';
  ...
  return (
    <footer className="relative overflow-hidden z-100">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-1/4 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-ai-blue-500/5 blur-[120px] -z-5"
      />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ 
        ...
        className="absolute bottom-0 right-1/4 transform translate-x-1/2 w-[400px] h-[400px] rounded-full bg-ai-teal-500/5 blur-[100px] -z-5"
      />
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 pb-16">
            ...
            >
              ...
              <p className="text-neutral-400 text-base leading-relaxed max-w-md font-sans">
              ...
              <div className="flex items-center gap-5">
                <a href="#" className="transform transition-all duration-300 hover:scale-110">
                  ...
                  >
                    ...
                    <Github className="w-6 h-6 text-neutral-300 group-hover:text-white relative z-10" />
                  </motion.div>
                </a>
                <a href="#" className="transform transition-all duration-300 hover:scale-110">
                  <motion.div 
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-ai-blue-500/50 to-ai-teal-500/50 rounded-full opacity-0 group-hover:opacity-70 blur-sm transition-opacity duration-300"></div>
                    <Linkedin className="w-6 h-6 text-neutral-300 group-hover:text-white relative z-10" />
                  </motion.div>
                </a>
                <a href="#" className="transform transition-all duration-300 hover:scale-110">
                  <motion.div 
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-ai-blue-500/50 to-ai-teal-500/50 rounded-full opacity-0 group-hover:opacity-70 blur-sm transition-opacity duration-300"></div>
                    <Twitter className="w-6 h-6 text-neutral-300 group-hover:text-white relative z-10" />
                  </motion.div>
                </a>
              </div>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="p-2 rounded-full bg-white/5 group-hover:bg-white/10 transition-colors">
                    <Mail className="w-4 h-4 text-ai-teal-400" />
                  </div>
                  <a href="mailto:contact@Ape.ai" className="text-neutral-400 group-hover:text-white transition-colors font-sans">
                    contact@Ape.ai
                  </a>
                </motion.div>
                ...
                >
                  <div className="p-2 rounded-full bg-white/5 group-hover:bg-white/10 transition-colors">
                    <MapPin className="w-4 h-4 text-ai-teal-400" />
                  </div>
                  <span className="text-neutral-400 group-hover:text-white transition-colors font-sans">
                    Mumbai, India
                  </span>
                </motion.div>
              </div>
          ...
          >
            <h3 className="text-center text-sm font-semibold uppercase tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-ai-blue-500 to-ai-teal-500 mb-6">
              Our Team
            </h3>
              ...
              {people.map((person) => (
                ...
                >
                  <div className="relative inline-block">
                    ...
                    <div className="relative w-16 h-16 rounded-full overflow-hidden ring-2 ring-white/10 group-hover:ring-ai-blue-500/50 transition-all duration-300">
                      <Image
                        src={person.image}
                        alt={person.name}
                        fill
                  ...
                  <div className="mt-3">
                    ...
                    <p className="text-xs text-neutral-400 mt-1">{person.designation}</p>
                    <a 
                      href={person.github} 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center mt-2 text-xs text-ai-blue-400 hover:text-ai-blue-300 transition-colors"
                    >
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <motion.button 
                whileHover={{ y: -2 }}
                className="px-3 py-1 text-xs text-neutral-400 hover:text-white bg-white/5 hover:bg-white/10 rounded-full transition-colors"
              >
                Cookie Settings
              </motion.button>
